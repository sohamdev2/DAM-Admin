    ...
    <div class="newAnalytics tableDetail customscrollbar">
      ...
      <div class="common-box bg-gray">
        <div class="table-list-view table-list-scrolling">
          <ul v-if="collectionByAssetsList.length" class="thead">
            <li>
              <div
                :class="[
              ...
              <!--              <div class="location sorting flex15">
                <span>Location</span>
              </div>-->
              <div
                :class="[
                  'total-shares sorting flex10',
              ...
              <div
                :class="[
                  'total-downloads sorting flex10',
          ...
          <div class="customscrollbar no_footer">
            <ContentLoader
              v-if="listLoading && !collectionByAssetsList.length"
              :speed="1"
              :animate="true"
              :width="400"
              :height="100"
            ...
            <ul v-if="collectionByAssetsList.length" class="tbody">
              <li v-for="file in collectionByAssetsList" :key="file.id">
                ...
                <!--                <div class="location tb-column flex15">
                  <div class="top-column">
                    <label>{{
                      file.location
                        ? JSON.parse(file.location).country_name
                        : '-'
                    }}</label>
                  </div>
                </div>-->
                <div class="total-shares tb-column flex10">
                  <div class="top-column">
            ...
            <EmptyState v-if="!listLoading && !collectionByAssetsList.length" />
          </div>
        </div>
      </div>
    </div>
...
export default {
  ...
  computed: {
    ...
    files: {
      get() {
        return this.collectionByAssetsList
      },
      set(value) {
        this.collectionByAssetsList = value
      },
    },
  },
  watch: {
  ...
  methods: {
    ...
    getCollectionDetails() {
      this.getCollectionByAssets()
    },
    async getCollectionByAssets() {
      this.listLoading = true
      let fileType = this.categoryBy
      if (this.categoryBy === 'document') {
        fileType = 'application'
      }
      let downloadType = this.activityType
      if (this.activityType === 'downloads') {
        downloadType = 'download'
      }
      if (this.activityType === 'shares') {
        downloadType = 'share'
      }
      await this.$axios
        .$post(`digital-assets/analytics/collection-assets-detail`, {
        ...
        .then(({ data }) => {
          ...
          this.collectionByAssetsList = data.assets
