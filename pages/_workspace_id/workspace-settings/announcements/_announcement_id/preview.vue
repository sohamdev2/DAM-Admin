<template>
  <div class="general-settings-right h-100">
    <div class="search-result mt1 pl10 pr10"></div>
    <div class="general-settings-title">
      <h4>Preview Announcement</h4>
    </div>
...
export default {
  ...
  methods: {
    ...
    async handleSubmit() {
      ...
      try {
        ...
        this.$toast.global.success(
          'New announcement has been successfully updated'
        )
    ...
    async getAnnouncement() {
      try {
        const { data } = await this.$axios.$get(
          `announcement/view?workspace_id=${this.internal_workspace_id}&announcement_id=${this.announcement_id}&module_id= 1`
        )
