  ...
  >
    <div class="general-settings-title">
      ...
      <div class="right-side">
        ...
        <nuxt-link
          :to="{
            name: 'workspace_id-workspace-settings-announcements-add',
                  ...
                  <div class="media">
                    ...
                    <div class="media-body">
                      <nuxt-link
                        ...
                        class="table-a"
                        :to="{
                          name: 'workspace_id-workspace-settings-announcements-announcement_id-edit',
                          params: {
                      ...
                      <nuxt-link
                        ...
                        class="table-a"
                        :to="{
                          name: 'workspace_id-workspace-settings-announcements-announcement_id-preview',
                          params: {
                            workspace_id: announcement.workspaces.workspace_id,
                            announcement_id: announcement.id,
                          },
      ...
      if (!isEmpty(this.deleteAnnouncementData)) {
        ...
        try {
          ...
          await this.$axios.$get(
            `announcement/delete?workspace_id=${workspace_id}&announcement_id=${id}&module_id= 1`
          )
