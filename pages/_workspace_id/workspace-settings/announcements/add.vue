              ...
              <div class="row">
                ...
                <div class="col-sm-12">
                  <div class="form-group mb0">
                    ...
                    <nuxt-link
                      :to="{
                        name: 'workspace_id-workspace-settings-announcements-list',
                        params: {
  ...
  methods: {
    async getUsers() {
      const { data } = await this.$axios.$get(
        `announcement/users?workspace_id=${this.internal_workspace_id}&module_id= 1`
      )
    ...
    async handleSubmit() {
      ...
      try {
        ...
        await this.$axios.$post(`announcement/add`, {
        ...
        let msg = ``
        if (this.isDrafted) {
          msg = `Announcement has been successfully saved as draft`
        } else if (this.isScheduled) {
          msg = `Announcement has been successfully scheduled at ${this.displayFormattedDate}`
        } else {
          msg = `Announcement has been successfully published`
        }
        this.$toast.global.success(msg)
